## This is the folder where the files (DXF, DWG or SLDPRT) for the metal parts are kept.  
...
The arms are laser-cut 2"x2" square 16ga (~1.6mm) laser-cut steel tubes - *arm1.SLDPRT*.  I will upload another shorter version of this arm in case you might need a different arm configuration. The tubes are in SLDPRT format as that is what my laser cutting supplier uses for tube cuts.
